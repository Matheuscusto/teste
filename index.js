...
const start = (kill = new Client()) => {
    console.log(color('\n[DEV]', 'red'), color('- Caio Mereos <-> +55 22 999586820'))
	console.log(color('[Michi]', 'red'), color('Minha inicialização foi concluída, você pode usar agora...\n'))
	
		
		kill.onStateChanged((state) => {
			console.log('[Estado da Michi]', state)
